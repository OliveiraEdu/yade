...
def minhafuncao(arq):
	if O.time<=2.0:
		...
		e6=O.bodies[5]
		e7=O.bodies[6]
		vz1=abs(e1.state.vel[2])
		vz2=abs(e2.state.vel[2])
		vz3=abs(e3.state.vel[2])
		vz4=abs(e4.state.vel[2])
		vz5=abs(e5.state.vel[2])
		vz6=abs(e6.state.vel[2])
		vz7=abs(e7.state.vel[2])
		...
		arq.write(str(O.time)+", "+str(vz1)+", "+str(pz1)+","+str(vz2)+", "+str(pz2)+", "+str(z3)+","+str(pz3)+", "+str(vz4)+", "+str(pz4)+","+str(vz5)+", "+str(pz5)+", "+str(vz6)+","+str(pz6)+", "+str(vz7)+", "+str(pz7)+"\n")
	else:
		arq.close()
		O.pause()
